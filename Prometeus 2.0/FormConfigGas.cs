    ...
    public partial class FormConfigGas : Form
    {
        ...
        public void Verify()
        {
            ...
            if (F1.ACO2[0] == "m")
            {
                ...
                grCO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grm.dat");
                t1CO2.Visible = false;
                t2CO2.Visible = false;
                t3CO2.Visible = false;
            }
            else
            {
                if (F1.ACO2[0] == "p")
                {
                    ...
                    WCO2.ForeColor = System.Drawing.Color.Lime;
                    grCO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grp.dat");
                    t1CO2.Visible = true;
                    t2CO2.Visible = false;
                    t3CO2.Visible = true;
                }
                else
                {
                    if (F1.ACO2[0] == "w")
                    {
                        ...
                        grCO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grw.dat");
                        t1CO2.Visible = true;
                        t2CO2.Visible = true;
                        t3CO2.Visible = false;
                    }
            ...
            if (F1.AN2[0] == "m")
            {
                ...
                grN2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grm.dat");
                t1N2.Visible = false;
                t2N2.Visible = false;
                t3N2.Visible = false;
            }
            else
            {
                if (F1.AN2[0] == "p")
                {
                    ...
                    WN2.ForeColor = System.Drawing.Color.Lime;
                    grN2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grp.dat");
                    t1N2.Visible = true;
                    t2N2.Visible = false;
                    t3N2.Visible = true;
                }
                else
                {
                    if (F1.AN2[0] == "w")
                    {
                        ...
                        grN2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grw.dat");
                        t1N2.Visible = true;
                        t2N2.Visible = true;
                        t3N2.Visible = false;
                    }
            ...
            if (F1.AO2[0] == "m")
            {
                ...
                grO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grm.dat");
                t1O2.Visible = false;
                t2O2.Visible = false;
                t3O2.Visible = false;
            }
            else
            {
                if (F1.AO2[0] == "p")
                {
                    ...
                    wO2.ForeColor = System.Drawing.Color.Lime;
                    grO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grp.dat");
                    t1O2.Visible = true;
                    t2O2.Visible = false;
                    t3O2.Visible = true;
                }
                else
                {
                    if (F1.AO2[0] == "w")
                    {
                        ...
                        grO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grw.dat");
                        t1O2.Visible = true;
                        t2O2.Visible = true;
                        t3O2.Visible = false;
                    }
            ...
            if (F1.CO2 == "on")
            {
                buttonCO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2g11.dat");
                labelCO2.Text = "ON";
            ...
            {
                buttonCO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2g10.dat");
                labelCO2.Text = "OFF";
            ...
            if (F1.N2 == "on")
            {
                buttonN2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2g21.dat");
                labelN2.Text = "ON";
            ...
            {
                buttonN2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2g20.dat");
                labelN2.Text = "OFF";
            ...
            if (F1.O2 == "on")
            {
                buttonO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2g31.dat");
                labelO2.Text = "ON";
            ...
            {
                buttonO2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2g30.dat");
                labelO2.Text = "OFF";
