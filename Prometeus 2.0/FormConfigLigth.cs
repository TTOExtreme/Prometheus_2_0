    ...
    public partial class FormConfigLigth : Form
    {
        ...
        public void Verify()
        {
            ...
            if (F1.ALight[0] == "m")
            {
                ...
                grl.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grm.dat");
                t1l.Visible = false;
                t2l.Visible = false;
                t3l.Visible = false;
            }
            else
            {
                if (F1.ALight[0] == "p")
                {
                    ...
                    wl.ForeColor = System.Drawing.Color.Lime;
                    grl.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grp.dat");
                    t1l.Visible = true;
                    t2l.Visible = false;
                    t3l.Visible = true;
                }
                else
                {
                    if (F1.ALight[0] == "w")
                    {
                        ...
                        grl.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grw.dat");
                        t1l.Visible = true;
                        t2l.Visible = true;
                        t3l.Visible = false;
                    }
            ...
            if (F1.AUv[0] == "m")
            {
                ...
                gru.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grm.dat");
                t1u.Visible = false;
                t2u.Visible = false;
                t3u.Visible = false;
            }
            else
            {
                if (F1.AUv[0] == "p")
                {
                    ...
                    wu.ForeColor = System.Drawing.Color.Lime;
                    gru.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grp.dat");
                    t1u.Visible = true;
                    t2u.Visible = false;
                    t3u.Visible = true;
                }
                else
                {
                    if (F1.AUv[0] == "w")
                    {
                        ...
                        gru.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grw.dat");
                        t1u.Visible = true;
                        t2u.Visible = true;
                        t3u.Visible = false;
                    }
            ...
            if (F1.Light == "on")
            {
                buttonLight.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2l1.dat");
                labelLight.Text = "ON";
            ...
            {
                buttonLight.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2l0.dat");
                labelLight.Text = "OFF";
            ...
            if (F1.UVLight == "on")
            {
                buttonUV.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2l1.dat");
                labelUv.Text = "ON";
            ...
            {
                buttonUV.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2l0.dat");
                labelUv.Text = "OFF";
