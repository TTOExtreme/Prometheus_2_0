    ...
    public partial class FormConfigDev : Form
    {
        ...
        public void Verify()
        {
            ...
            if (F1.ADev1[0] == "m")
            {
                ...
                grDev1.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grm.dat");
            ...
            else
            {
                if (F1.ADev1[0] == "p")
                {
                    ...
                    WDev1.ForeColor = System.Drawing.Color.Lime;
                    grDev1.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grp.dat");
                    t1Dev1.Visible = true;
                    t2Dev1.Visible = false;
                    t3Dev1.Visible = true;
                }
                else
                {
                    if (F1.ADev1[0] == "w")
                    {
                        ...
                        grDev1.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grw.dat");
                        t1Dev1.Visible = true;
                        t2Dev1.Visible = true;
                        t3Dev1.Visible = false;
                    }
            ...
            if (F1.ADev2[0] == "m")
            {
                ...
                grDev2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grm.dat");
            ...
            else
            {
                if (F1.ADev2[0] == "p")
                {
                    ...
                    WDev2.ForeColor = System.Drawing.Color.Lime;
                    grDev2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grp.dat");
                    t1Dev2.Visible = true;
                    t2Dev2.Visible = false;
                    t3Dev2.Visible = true;
                }
                else
                {
                    if (F1.ADev2[0] == "w")
                    {
                        ...
                        grDev2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grw.dat");
                        t1Dev2.Visible = true;
                        t2Dev2.Visible = true;
                        t3Dev2.Visible = false;
                    }
            ...
            if (F1.ADev3[0] == "m")
            {
                ...
                grDev3.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grm.dat");
            ...
            else
            {
                if (F1.ADev3[0] == "p")
                {
                    ...
                    WDev3.ForeColor = System.Drawing.Color.Lime;
                    grDev3.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grp.dat");
                    t1Dev3.Visible = true;
                    t2Dev3.Visible = false;
                    t3Dev3.Visible = true;
                }
                else
                {
                    if (F1.ADev3[0] == "w")
                    {
                        ...
                        grDev3.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2grw.dat");
                        t1Dev3.Visible = true;
                        t2Dev3.Visible = true;
                        t3Dev3.Visible = false;
                    }
            ...
            if (F1.Dev1 == "on")
            {
                buttonDev1.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d11.dat");
                labelDev1.Text = "ON";
            ...
            {
                buttonDev1.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d10.dat");
                labelDev1.Text = "OFF";
            ...
            if (F1.Dev2 == "on")
            {
                buttonDev2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d11.dat");
                labelDev2.Text = "ON";
            ...
            {
                buttonDev2.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d10.dat");
                labelDev2.Text = "OFF";
            ...
            if (F1.Dev3 == "on")
            {
                buttonDev3.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d11.dat");
                labelDev3.Text = "ON";
            ...
            {
                buttonDev3.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d10.dat");
                labelDev3.Text = "OFF";
