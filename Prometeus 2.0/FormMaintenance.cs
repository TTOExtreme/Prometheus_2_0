...
namespace Prometeus_2._0
{
    public partial class FormMaintenance : Form
    {
        ...
        public void Verify()
        {
            ...
            if (F1.Heat == "on")
            {
                buttonHeatVd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2h1.dat");
                labelHeat.Text = "ON";
            ...
            {
                buttonHeatVd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2h0.dat");
                labelHeat.Text = "OFF";
            ...
            if (F1.Pump == "on")
            {
                buttonPumpVd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2p1.dat");
                labelPump.Text = "ON";
            ...
            {
                buttonPumpVd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2p0.dat");
                labelPump.Text = "OFF";
            ...
            if (F1.Fan == "on")
            {
                buttonFanVd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2f1.dat");
                labelFan.Text = "ON";
            ...
            {
                buttonFanVd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2f0.dat");
                labelFan.Text = "OFF";
