...
using Prometeus_2._0.Properties;
...
namespace Prometeus_2._0
{
    public partial class FormConfigSecurity : Form
    {
        ...
        public void Verify()
        {
            ...
            if (F1.Heat == "on")
            {
                buttonHeat.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2h1.dat");
            }
            else
            {
                buttonHeat.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2h0.dat");
            }
            //pump
            if (F1.Pump == "on")
            {
                buttonPump.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2p1.dat");
            }
            else
            {
                buttonPump.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2p0.dat");
            }
            //fan
            if (F1.Fan == "on")
            {
                buttonFan.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2f1.dat");
            }
            else
            {
                buttonFan.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2f0.dat");
            }
            //dev1
            if (F1.Dev1 == "on")
            {
            ...
            if (F1.Dev2 == "on")
            {
                buttonDev1Vd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d21.dat");
            }
            else
            {
                buttonDev1Vd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d20.dat");
            }
            //dev3
            if (F1.Dev3 == "on")
            {
                buttonDev2Vd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d31.dat");
            }
            else
            {
                buttonDev2Vd.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2d30.dat");
            }
            //co2
            if (F1.CO2 == "on")
            {
            ...
            if (F1.lFan == "on")
            {
                lockFan.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock1.dat");
            }
            else
            {
                lockFan.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock0.dat");
            }
            if (F1.lHeat == "on")
            {
                lockHeat.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock1.dat");
            }
            else
            {
                lockHeat.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock0.dat");
            }
            if (F1.lPump == "on")
            {
                lockPump.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock1.dat");
            }
            else
            {
                lockPump.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock0.dat");
            }
            if (F1.lLight == "on")
            {
            ...
            if (F1.lTemp == "on")
            {
                lockTemp.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock1.dat");
            }
            else
            {
                lockTemp.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock0.dat");
            }
            if (F1.lDev == "on")
            {
                lockDev.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock1.dat");
            }
            else
            {
                lockDev.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock0.dat");
            }
            if (F1.lGas == "on")
            {
                lockGas.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock1.dat");
            }
            else
            {
                lockGas.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock0.dat");
            }
            if (F1.lLig == "on")
            {
                lockLig.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock1.dat");
            }
            else
            {
                lockLig.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock0.dat");
            }
            if (F1.lRepo == "on")
            {
            ...
            if (F1.lBlue == "on")
            {
                lockBlue.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock1.dat");
            }
            else
            {
                lockBlue.BackgroundImage = new Bitmap(@"C:\Biofabris\bin\res\bfp2lock0.dat");
            }
        }
